...
public class MandelbrotGui extends Application implements MandelbrotProcessorListener
{
  ...
  private void startOrStopProcessing()
  {
    ...
    else
    {
      ...
      //System.out.println("Start processing using " + processor.getClass().getSimpleName() + " with " + threadCount + " threads.");
      System.out.printf("Start processing using %s with %d threads.%n", processor.getClass().getSimpleName(), threadCount);
  ...
  public void processingStopped(long duration)
  {
    ...
    System.out.printf("Finished processing after %d ms%n");
  }
